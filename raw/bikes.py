...
@transform()
class DataValidate:
    df = extract(table="/app/data/landing/bike/", format="json", options=(("multiline", "true"),))

    @load(format="iceberg", mode="overwrite", table="raw.vehicles.bikes", keys=["name"])
...
if __name__ == "__main__":
    ETLManager.run_all(name="RawBikes")
